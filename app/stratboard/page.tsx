...
export default function StratBoard () {
    ...
    return (
        <div className="flex flex-col h-screen text-2xl tracking-wider">
            <div className="bg-slate-950 border-b border-slate-600 h-[5%] px-60 py-2"><TopNav /></div>
            <div className="flex w-full h-[85%] flex-row border-b border-slate-600">
            ...
            <div className="bg-slate-950 h-[10%]"><BottomBar /></div>
        </div>
    );
}